...
import { hightlightsSlides } from "../../variables";
...
const VideoCarousel = () => {
  ...
  useGSAP(() => {
    ...
    // play the video when it is in the view
    gsap.to("#video", {
      scrollTrigger: {
        trigger: "#video",
  ...
  useEffect(() => {
    ...
    if (span[videoId]) {
      ...
      const anim = gsap.to(span[videoId], {
        ...
        // when the video ended, replace the progress bar with indicator and change background color
        onComplete: () => {
          if (isPlaying) {
            gsap.to(videoDivRef.current[videoId], {
              width: "12px",
      ...
      // remove the ticker when video is paused
  ...
  useEffect(() => {
    if (loadedData.length > 3) {
      ...
      else if (startPlay) videoRef.current[videoId]?.play();
    }
